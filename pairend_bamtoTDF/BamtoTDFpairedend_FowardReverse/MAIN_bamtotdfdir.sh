indir=/scratch/Users/allenma/scripts/testbam/paireddatabackup/
...
#notes           :Edit the in directory at the top of the script to be your directory of bam files.  All the bam files must be single end. This script uses several other scripts located in the same directory and submits jobs to tourque. Handles spliced reads correctly.



bedgraphdir=${outdir}genomecoveragebedpair/
bedgraphfortdfdir=${outdir}genomecoveragebedpair/fortdf/
tdfdir=${outdir}genomecoveragebedpair/fortdf/tdfs/
