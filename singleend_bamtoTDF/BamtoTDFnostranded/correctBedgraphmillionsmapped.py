...
def main(Bedgraphfile, flagstatfile):
	total_reads = mappedfromflagstat(flagstatfile)
	f = open(Bedgraphfile)
...
if __name__=="__main__":
	if len(sys.argv)>1:
		...
		flagstatfile = sys.argv[2]
		main(Bedgraphfile, flagstatfile)
	else:
		print "python correctBedgraphmillionsmapped.py <Bedgraphfile after cat with pos and negative strands> <flagstat file>"
